...
namespace ERP_GMEDINA.Controllers
{
    public class EmpleadoComisionesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Inactivar([Bind(Include = "cc_Id,cc_UsuarioModifica,cc_FechaModifica")] tbEmpleadoComisiones tbEmpleadoComisiones)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //EJECUTAR PROCEDIMIENTO ALMACENADO
                    listEmpleadoComisiones = db.UDP_Plani_EmpleadoComisiones_Inactivar(tbEmpleadoComisiones.cc_Id,
                                                                                            tbEmpleadoComisiones.cc_UsuarioModifica,
                                                                                            tbEmpleadoComisiones.cc_FechaModifica);
                    //RECORRER EL TIPO COMPLEJO DEL PROCEDIMIENTO ALMACENADO PARA EVALUAR EL RESULTADO DEL SP
